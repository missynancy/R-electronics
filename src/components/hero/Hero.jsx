    ...
    <div className='hero'>
        ...
        <div className="dots">
            <ul className='hero-dots'>
                ...
                <li onClick={() => setHeroCount(6)} className={heroCount === 6 ? "hero-dot orange" : "hero-dot plain"}></li>
                <li onClick={() => setHeroCount(7)} className={heroCount === 7 ? "hero-dot orange" : "hero-dot plain"}></li>
                <li onClick={() => setHeroCount(8)} className={heroCount === 8 ? "hero-dot orange" : "hero-dot plain"}></li>
            </ul>
        </div>
    </div>
  )
